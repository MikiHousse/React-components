    ...
    <div className='container mx-auto'>
        ...
        <div className='pt-6'>
            <div className='flex gap-5 justify-center'>
                ...
                <input className='text-2xl pl-2' type="date" value={`${year}-0${month}-0${date}`}/>
                <div className='flex'>
                    <input className=' rounded-l-sm text-2xl pl-2' type="number" min='100' max='2000' onChange={e => setKcal(e.target.value)} step={step} value={kcal}/>
